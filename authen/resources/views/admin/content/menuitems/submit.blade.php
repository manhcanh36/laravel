...
@section('content')
    ...
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            <form name="category" action="{{ url('admin/menuitems') }}" method="post" class="form-horizontal">
                @csrf
                ...
                <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">Kiểu menuitems</label>
                    <div class="col-sm-8">
                        <select name="type">
